            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control kredikarti" id="kartnoi" name="kartno" style="font-size:20px;" required>
                    </div>
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                           <div class="form-group">
                               ...
                               <!-- adres ve telefonlar kulanıcı detay tablosunda old. için direkt oradan cektim-->
                           </div>
                       </div>
                   </div>
                </div>
