        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <form class="navbar-form navbar-left" action="{{ route('urun_ara') }}" method="post">
                    {{ csrf_field() }} <!-- bunu mutlaka her form da tnmlamamk lazım -->
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#"><i class="fa fa-shopping-cart"></i> Sepet <span class="badge badge-theme">{{ Cart::count() }}</span></a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit()">Çıkış</a>
                                <!-- bu şekilde bağlantı yapmamızın amacı dısarıdan biri çıkış iişlemini yapamasın diye-->
