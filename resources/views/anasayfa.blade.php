                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 product">
                            <a href="{{ route('urun', $urun_detay->urun->slug) }}"><img src="img/5.jpg"></a>
            ...
            <div class="panel panel-theme">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 product">
                            <a href="{{ route('urun' , $urun_detay->urun->slug) }}"><img src="img/21.jpg"></a>
                            <p><a href="{{ route('urun', $urun_detay->urun->slug) }}">{{ $urun_detay->urun->urun_adi }}</a></p>
                            <p class="price">{{ $urun_detay->urun->fiyati }} ₺</p>
                        </div>
                       @endforeach
            ...
            <div class="panel panel-theme">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 product">
                            <a href="{{ route('urun', $urun_detay->urun->slug) }}"><img src="img/24.jpg"></a>
                            <p><a href="{{ route('urun', $urun_detay->urun->slug) }}">{{ $urun_detay->urun->urun_adi }}</a></p>
                            <p class="price">{{ $urun_detay->urun->fiyati }} ₺</p>
                        </div>
                        @endforeach
